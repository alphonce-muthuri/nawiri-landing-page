...
export function AppCta() {
  return (
    <section className="min-w-0 py-16 sm:py-24 lg:py-28 border-t border-border bg-[oklch(0.97_0.02_83)]">
      <div className="max-w-6xl mx-auto min-w-0 px-4 sm:px-6">
        <div className="grid min-w-0 lg:grid-cols-[1fr_400px] gap-6 lg:gap-12 xl:gap-20 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-col min-[360px]:flex-row flex-wrap gap-3 mb-6 sm:mb-8">
              <button
                type="button"
                className="flex items-center justify-center gap-3 w-full min-[360px]:w-auto min-[360px]:flex-1 lg:flex-initial bg-foreground text-background rounded-xl px-4 py-3 sm:py-2.5 hover:opacity-90 transition-opacity"
              >
